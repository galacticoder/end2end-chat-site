...
export const ChatBubbleIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g style={{ transition: 'opacity 200ms ease-in-out' }}>
        <path
      ...
      <g style={{ transition: 'opacity 200ms ease-in-out' }}>
        <path
          d="M12 2.5957C6.75332 2.5957 2.50002 6.849 2.50002 12.0957C2.50002 14.4488 3.35633 16.603 4.77303 18.262L2.71969 20.3154C2.50519 20.5299 2.44103 20.8525 2.55711 21.1327C2.6732 21.413 2.94668 21.5957 3.25002 21.5957H12C17.2467 21.5957 21.5 17.3424 21.5 12.0957C21.5 6.849 17.2467 2.5957 12 2.5957Z"
          fill="#bbbbbbd8"
...
// Call Icon
export const CallIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => {
  const isFilled = className?.includes('fill-current');
...
// Custom Settings Icon (with outlined/filled states)
...
// Custom Unblock Icon
export const UnblockIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        d="M20.5 12C20.5 7.30558 16.6944 3.5 12 3.5C7.30558 3.5 3.5 7.30558 3.5 12C3.5 16.6944 7.30558 20.5 12 20.5C16.6944 20.5 20.5 16.6944 20.5 12ZM22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
        fill="currentColor"
      />
      <path
        opacity="0.4"
        d="M18.0096 4.92953C18.3024 4.6367 18.7772 4.63684 19.0702 4.92953C19.363 5.22242 19.363 5.69718 19.0702 5.99007L5.9891 19.0711C5.6962 19.364 5.22144 19.364 4.92855 19.0711C4.63587 18.7782 4.63573 18.3034 4.92855 18.0106L18.0096 4.92953Z"
        fill="currentColor"
      />
    </svg>
  );
